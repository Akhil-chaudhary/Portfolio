      ...
      >
        {projects.map((project, idx) => (
          <motion.div
            ...
            className="group bg-[#0d0d12]/60 border border-[#1f1f2e]/60 rounded-3xl overflow-hidden hover:border-[#3b82f6]/40 hover:bg-[#0d0d12]/90 transition-all duration-500 flex flex-col h-full shadow-lg relative"
          >
            {/* Project Image Panel */}
            ...
            <div className="p-6 flex flex-col justify-between flex-grow">
              <div>
                <h3 className="text-xl font-bold text-white group-hover:text-blue-400 transition-colors duration-300 tracking-tight mb-2 flex items-center justify-between">
              ...
              <div>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 text-xs font-semibold tracking-wider uppercase text-blue-400 hover:text-white group-hover:translate-x-1 transition-all duration-300 cursor-pointer border-t border-neutral-900 w-full pt-4"
                >
